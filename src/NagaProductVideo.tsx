...
/* ───────── Brand Tokens (copied from NagaVideo) ───────── */
const C = {
  navy: "#0a2540",
  blue: "#0094d7",
  teal: "#28b9d0",
...
/* ───────── Icon Components ───────── */
const IconGlobe: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.teal }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>
  </svg>
);

const IconUsers: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.teal }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>
  </svg>
);

const IconChart: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.teal }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/>
  </svg>
);

const IconTrophy: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.teal }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2z"/>
  </svg>
);

const IconMessage: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.blue }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
  </svg>
);

const IconDatabase: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.blue }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/>
  </svg>
);

const IconSearch: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.blue }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>
  </svg>
);

const IconUserCheck: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.blue }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><polyline points="17 11 19 13 23 9"/>
  </svg>
);

const IconBrain: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.blue }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.46 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 1.98-3A2.5 2.5 0 0 1 9.5 2Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.46 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-3A2.5 2.5 0 0 0 14.5 2Z"/>
  </svg>
);

const IconFileText: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.blue }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><line x1="16" x2="8" y1="13" y2="13"/><line x1="16" x2="8" y1="17" y2="17"/><line x1="10" x2="8" y1="9" y2="9"/>
  </svg>
);

const IconMic: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.white }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" x2="12" y1="19" y2="22"/>
  </svg>
);

const IconTarget: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.white }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>
  </svg>
);

const IconBriefcase: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.white }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/>
  </svg>
);

const IconTeam: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.white }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>
  </svg>
);

const IconMap: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.white }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <polygon points="3 6 9 3 15 6 21 3 21 18 15 21 9 18 3 21"/><line x1="9" x2="9" y1="3" y2="18"/><line x1="15" x2="15" y1="6" y2="21"/>
  </svg>
);

const IconAward: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.white }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/>
  </svg>
);

const IconSettings: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.white }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/>
  </svg>
);

const IconTrending: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.white }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/>
  </svg>
);

const IconChess: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.white }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M8 22l4-10 4 10"/><path d="M12 12V8a2 2 0 0 1 4 0v4"/><path d="M12 8V4a2 2 0 0 0-4 0v4"/><circle cx="12" cy="2" r="1"/><path d="M4 22h16"/>
  </svg>
);

const IconShieldWarn: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.navy }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/>
  </svg>
);

const IconLock: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.navy }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>
  </svg>
);

const IconEye: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.navy }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/>
  </svg>
);

const IconSparkles: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = C.navy }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const Footer: React.FC<{ dark?: boolean }> = ({ dark = false }) => (
  ...
  >
    <LogoIntra size={20} wordmark={false} />
    <span
      style={{
        fontSize: 13,
        fontWeight: 600,
        color: dark ? C.white : C.slate,
        letterSpacing: 1,
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
        ...
        >
          <div style={{ flex: 1 }}>
            {bullets.map((b, i) => {
              const op = fade(18 + i * 10, 14);
              const y = slideY(18 + i * 10, 20);
              const Icon = b.icon;
              return (
                <div
                  key={i}
                ...
                >
                  ...
                  <span style={{ fontSize: 22, color: C.charcoal, lineHeight: 1.5 }}>
                    {b.text}
                  </span>
                </div>
              );
          ...
          <div
            style={{
              ...
              padding: 40,
              opacity: fade(55, 18),
              transform: `translateX(${slideX(55, 40)}px)`,
          ...
          >
            ...
            >
              The problem is that almost none of it is accessible.
            </div>
            <div
              style={{
                fontSize: 18,
            ...
            >
              It lives in incomplete Salesforce records, emails no one searches, and
              meetings no one transcribed. As Intralink grows, this becomes a
              structural risk — and a structural opportunity.
            </div>
          </div>
        </div>
      </div>
...
const WhatIsScene: React.FC = () => {
  return (
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
        <SectionLabel text="What NAGA Is" delay={0} />
        <div
          style={{
            fontSize: 48,
            fontWeight: 700,
        ...
        >
          Intralink&apos;s institutional intelligence platform
        </div>
        ...
        >
          {[
            { label: "Not a chatbot", delay: 20 },
            { label: "Not a search tool", delay: 30 },
            { label: "The intelligence layer", delay: 40 },
          ].map((item, i) => {
            const op = fade(item.delay, 14);
            const y = slideY(item.delay, 20);
            const isLast = i === 2;
            return (
              <div
                key={i}
                style={{
                  flex: 1,
                  backgroundColor: isLast ? C.navy : C.lightGray,
                  borderRadius: 16,
                  padding: "28px 24px",
                  opacity: op,
                  transform: `translateY(${y}px)`,
                  boxShadow: isLast ? "0 12px 40px rgba(10,37,64,0.18)" : "none",
                }}
              >
                <div
                  style={{
                    fontSize: 13,
                    fontWeight: 700,
                    opacity: isLast ? 0.7 : 0.5,
                    marginBottom: 8,
                    letterSpacing: 1,
                    textTransform: "uppercase",
                    color: isLast ? C.white : C.slate,
                  }}
                >
                  {isLast ? "What it is" : "What it is not"}
                </div>
                <div
                  style={{
                    fontSize: 24,
        ...
        >
          ...
          >
            The goal: every employee, on any engagement, immediately has access to
            what Intralink already knows.
          </div>
        </div>
      </div>
      <Footer />
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1300, margin: "0 auto", width: "100%" }}>
        <SectionLabel text="What It Solves" delay={0} />
        <div
          style={{
            fontSize: 42,
            fontWeight: 700,
        ...
        >
          {items.map((item, i) => {
            const op = fade(16 + i * 8, 14);
            const y = slideY(16 + i * 8, 20);
...
/* ═══════════════════════════════════════
   SCENE 4  —  Six Intelligence Domains  (27–37s)
   ═══════════════════════════════════════ */
const DomainsScene: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1300, margin: "0 auto", width: "100%" }}>
        <SectionLabel text="Six Intelligence Domains" delay={0} />
        <div
          style={{
            fontSize: 42,
            fontWeight: 700,
        ...
        >
          {domains.map((d, i) => {
            const op = fade(d.delay + 14, 14);
            const y = slideY(d.delay + 14, 20);
            const Icon = d.icon;
            return (
              <div
                key={i}
                style={{
                  ...
                  opacity: op,
                  transform: `translateY(${y}px)`,
                  boxShadow: "0 12px 40px rgba(0,148,215,0.15)",
                  color: C.white,
                }}
              >
                <div
...
const AdvantageScene: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
        <SectionLabel text="Competitive Advantage" delay={0} />
        <div
          style={{
            fontSize: 46,
            fontWeight: 700,
        ...
        >
          No competitor has access to Intralink&apos;s 13 years of experience.
        </div>
        ...
        >
          This is knowledge that cannot be purchased. It can only be accumulated
          over time — and Intralink has already accumulated it.
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          {points.map((p, i) => {
            const op = fade(30 + i * 12, 14);
            const x = slideX(30 + i * 12, 30);
            return (
              <div
                key={i}
                style={{
...
const RolloutScene: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
        <SectionLabel text="Rollout Plan" delay={0} />
        <div
          style={{
            fontSize: 42,
            fontWeight: 700,
        ...
        >
          Five phases. 12 months. Contained risk.
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {phases.map((p, i) => {
            const op = fade(p.delay + 14, 14);
            const x = slideX(p.delay + 14, i % 2 === 0 ? -30 : 30);
            return (
              <div
                key={i}
                style={{
        ...
        >
          <Divider />
          <div style={{ fontSize: 18, color: C.blue, fontWeight: 600 }}>
            Phase 1 delivers measurable value within 60 days.
          </div>
        </div>
      </div>
      <Footer />
...
const ReturnsScene: React.FC = () => {
  const cards = [
    {
      label: "Operational",
      items: [
        "Material reduction in manual CRM work",
    ...
    },
    {
      ...
      items: [
        ...
        "Stronger client engagement context",
      ],
      color: C.teal,
      delay: 12,
      icon: IconTrending,
    },
    {
      label: "Strategic",
      items: [
        "Permanent preservation of institutional knowledge",
        "Compounding advantage with every engagement",
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1300, margin: "0 auto", width: "100%" }}>
        <SectionLabel text="Expected Returns" delay={0} />
        <div
          style={{
            fontSize: 42,
            fontWeight: 700,
        ...
        >
          Operational, Commercial, Strategic.
        </div>

        <div style={{ display: "flex", gap: 24 }}>
          {cards.map((c, i) => {
            const op = fade(c.delay + 16, 14);
            const y = slideY(c.delay + 16, 20);
            const Icon = c.icon;
            return (
              <div
                key={i}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {c.items.map((item, j) => (
                    ...
                    >
                      ...
                      />
                      <span style={{ fontSize: 18, lineHeight: 1.5, opacity: 0.95 }}>
                        {item}
                      </span>
                    </div>
                  ))}
...
/* ═══════════════════════════════════════
   SCENE 8  —  Risks & Mitigations  (62–70s)
   ═══════════════════════════════════════ */
const RisksScene: React.FC = () => {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1300, margin: "0 auto", width: "100%" }}>
        <SectionLabel text="Key Risks & Mitigations" delay={0} />
        <div
          style={{
            fontSize: 42,
            fontWeight: 700,
        ...
        >
          {risks.map((r, i) => {
            const op = fade(16 + i * 10, 14);
            const y = slideY(16 + i * 10, 20);
            const Icon = r.icon;
            return (
              <div
                key={i}
  ...
  return (
    ...
    >
      <div style={{ transform: `scale(${s})` }}>
        <LogoIntra size={100} wordmark={true} />
      </div>
...
/* ═══════════════════════════════════════
   MAIN COMPOSITION  (78s / 2340f @ 30fps)
   ═══════════════════════════════════════ */
export const NagaProductVideo: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: C.white, fontFamily: FONT }}>
      {/* 0. Title Card  0:00 – 0:03  (90f) */}
      <Sequence from={0} durationInFrames={90}>
        <TitleScene />
      </Sequence>

      {/* 1. Opportunity  0:03 – 0:10  (210f) */}
      <Sequence from={90} durationInFrames={210}>
        <OpportunityScene />
      </Sequence>

      {/* 2. What NAGA Is  0:10 – 0:17  (210f) */}
      <Sequence from={300} durationInFrames={210}>
        <WhatIsScene />
      </Sequence>

      {/* 3. What It Solves  0:17 – 0:27  (300f) */}
      <Sequence from={510} durationInFrames={300}>
        <SolvesScene />
      </Sequence>

      {/* 4. Six Domains  0:27 – 0:37  (300f) */}
      <Sequence from={810} durationInFrames={300}>
        <DomainsScene />
      </Sequence>

      {/* 5. Competitive Advantage  0:37 – 0:44  (210f) */}
      <Sequence from={1110} durationInFrames={210}>
        <AdvantageScene />
      </Sequence>

      {/* 6. Rollout Plan  0:44 – 0:54  (300f) */}
      <Sequence from={1320} durationInFrames={300}>
        <RolloutScene />
      </Sequence>

      {/* 7. Expected Returns  0:54 – 1:02  (240f) */}
      <Sequence from={1620} durationInFrames={240}>
        <ReturnsScene />
      </Sequence>

      {/* 8. Risks & Mitigations  1:02 – 1:10  (240f) */}
      <Sequence from={1860} durationInFrames={240}>
        <RisksScene />
      </Sequence>

      {/* 9. Closing  1:10 – 1:18  (240f) */}
